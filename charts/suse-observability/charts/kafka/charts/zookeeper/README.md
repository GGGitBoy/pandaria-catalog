...
![Version: 10.2.4](https://img.shields.io/badge/Version-10.2.4-informational?style=flat-square) ![AppVersion: 3.8.0](https://img.shields.io/badge/AppVersion-3.8.0-informational?style=flat-square)

Apache ZooKeeper provides a reliable, centralized register of configuration data and services for distributed applications.

**Homepage:** <https://github.com/bitnami/charts/tree/main/bitnami/zookeeper>
...
| image.tag | string | `"3.8.0-debian-11-r47"` |  |
| initContainers | list | `[]` |  |
| initLimit | int | `10` |  |
| jvmFlags | string | `""` |  |
| kubeVersion | string | `""` |  |
...
| volumePermissions.image.tag | string | `"11-debian-11-r42"` |  |
