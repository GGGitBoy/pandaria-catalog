...
Current chart version is `2.3.3`
...
| anomaly-detection.image.registry | string | `"registry.rancher.com"` | Base container image registry for all containers, except for the wait container |
| anomaly-detection.image.spotlightRepository | string | `"suse-observability/spotlight"` | Repository of the spotlight Docker image. |
...
| clickhouse.backup.image.registry | string | `"registry.rancher.com"` | Registry where to get the image from. |
| clickhouse.backup.image.repository | string | `"suse-observability/clickhouse-backup"` | Repository where to get the image from. |
...
| clickhouse.image.registry | string | `"registry.rancher.com"` | Registry where to get the image from |
| clickhouse.image.repository | string | `"suse-observability/clickhouse"` | Repository where to get the image from. |
...
| elasticsearch.imageRegistry | string | `"registry.rancher.com"` |  |
| elasticsearch.imageRepository | string | `"suse-observability/elasticsearch"` |  |
...
| elasticsearch.prometheus-elasticsearch-exporter.image.registry | string | `"registry.rancher.com"` |  |
| elasticsearch.prometheus-elasticsearch-exporter.image.repository | string | `"suse-observability/elasticsearch-exporter"` |  |
...
| hbase.all.image.registry | string | `"registry.rancher.com"` |  |
...
| hbase.console.image.repository | string | `"suse-observability/stackgraph-console"` |  |
...
| hbase.hbase.master.image.repository | string | `"suse-observability/hbase-master"` |  |
...
| hbase.hbase.regionserver.image.repository | string | `"suse-observability/hbase-regionserver"` |  |
...
| hbase.hdfs.image.repository | string | `"suse-observability/hadoop"` |  |
...
| hbase.stackgraph.image.repository | string | `"suse-observability/stackgraph-hbase"` |  |
| hbase.stackgraph.version | string | `"7.9.6"` | The StackGraph server version, must be compatible with the StackState version |
| hbase.tephra.image.repository | string | `"suse-observability/tephra-server"` |  |
...
| hbase.wait.image.registry | string | `"registry.rancher.com"` |  |
| hbase.wait.image.repository | string | `"suse-observability/wait"` |  |
...
| hbase.zookeeper.image.registry | string | `"registry.rancher.com"` |  |
| hbase.zookeeper.image.repository | string | `"suse-observability/zookeeper"` |  |
...
| kafka.image.registry | string | `"registry.rancher.com"` | Kafka image registry |
| kafka.image.repository | string | `"suse-observability/kafka"` | Kafka image repository |
...
| kafka.metrics.jmx.image.registry | string | `"registry.rancher.com"` | Kafka JMX exporter image registry |
| kafka.metrics.jmx.image.repository | string | `"suse-observability/jmx-exporter"` | Kafka JMX exporter image repository |
...
| kafkaup-operator.image.registry | string | `"registry.rancher.com"` |  |
| kafkaup-operator.image.repository | string | `"suse-observability/kafkaup-operator"` |  |
...
| kubernetes-rbac-agent.containers.rbacAgent.image.registry | string | `"registry.rancher.com"` | Registry for the docker image. |
| kubernetes-rbac-agent.containers.rbacAgent.image.repository | string | `"suse-observability/kubernetes-rbac-agent"` |  |
...
| minio.image.registry | string | `"registry.rancher.com"` | MinIO image registry |
| minio.image.repository | string | `"suse-observability/minio"` | MinIO image repository |
...
| opentelemetry-collector.image.registry | string | `"registry.rancher.com"` |  |
| opentelemetry-collector.image.repository | string | `"suse-observability/sts-opentelemetry-collector"` | Repository where to get the image from. |
| opentelemetry-collector.image.tag | string | `"v0.0.19"` | Container image tag for 'opentelemetry-collector' containers. |
...
| role-k8s-authz.enabled | bool | `false` | Deploy the Role(s) to populate permissions on Suse Observability |
...
| stackstate.components.all.image.registry | string | `"registry.rancher.com"` | Base container image registry for all StackState containers, except for the wait container and the container-tools container |
| stackstate.components.all.image.repositorySuffix | string | `""` |  |
| stackstate.components.all.image.tag | string | `"7.0.0-snapshot.20250430171416-master-f683b3c"` | The default tag used for all stateless components of StackState; invividual service `tag`s can be overriden (see below). |
...
| stackstate.components.api.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the api component Docker image. |
...
| stackstate.components.authorizationSync.image.repository | string | `"suse-observability/stackstate-server"` |  |
...
| stackstate.components.checks.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the sync component Docker image. |
...
| stackstate.components.clickhouseCleanup.image.registry | string | `"registry.rancher.com"` |  |
| stackstate.components.clickhouseCleanup.image.repository | string | `"suse-observability/clickhouse"` |  |
...
| stackstate.components.containerTools.image.registry | string | `"registry.rancher.com"` | Base container image registry for container-tools containers. |
| stackstate.components.containerTools.image.repository | string | `"suse-observability/container-tools"` | Base container image repository for container-tools containers. |
| stackstate.components.containerTools.image.tag | string | `"1.5.5"` | Container image tag for container-tools containers. |
...
| stackstate.components.correlate.image.repository | string | `"suse-observability/stackstate-correlate"` | Repository of the correlate component Docker image. |
...
| stackstate.components.e2es.image.repository | string | `"suse-observability/stackstate-kafka-to-es"` | Repository of the e2es component Docker image. |
...
| stackstate.components.healthSync.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the healthSync component Docker image. |
...
| stackstate.components.initializer.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the initializer component Docker image. |
...
| stackstate.components.kafkaTopicCreate.image.registry | string | `"registry.rancher.com"` | Base container image registry for kafka-topic-create containers. |
| stackstate.components.kafkaTopicCreate.image.repository | string | `"suse-observability/kafka"` | Base container image repository for kafka-topic-create containers. |
...
| stackstate.components.nginxPrometheusExporter.image.registry | string | `"registry.rancher.com"` | Base container image registry for nginx-prometheus-exporter containers. |
| stackstate.components.nginxPrometheusExporter.image.repository | string | `"suse-observability/nginx-prometheus-exporter"` | Base container image repository for nginx-prometheus-exporter containers. |
...
| stackstate.components.notification.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the notification component Docker image. |
...
| stackstate.components.receiver.image.repository | string | `"suse-observability/stackstate-receiver"` | Repository of the receiver component Docker image. |
...
| stackstate.components.router.image.registry | string | `"registry.rancher.com"` | Registry of the router component Docker image. |
| stackstate.components.router.image.repository | string | `"suse-observability/envoy"` | Repository of the router component Docker image. |
...
| stackstate.components.router.mode.image.registry | string | `"registry.rancher.com"` | Base container image registry for router mode containers. |
| stackstate.components.router.mode.image.repository | string | `"suse-observability/container-tools"` | Base container image repository for router mode containers. |
| stackstate.components.router.mode.image.tag | string | `"1.5.5"` | Container image tag for router mode containers. |
...
| stackstate.components.server.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the server component Docker image. |
...
| stackstate.components.slicing.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the slicing component Docker image. |
...
| stackstate.components.state.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the sync component Docker image. |
...
| stackstate.components.sync.image.repository | string | `"suse-observability/stackstate-server"` | Repository of the sync component Docker image. |
...
| stackstate.components.ui.image.repository | string | `"suse-observability/stackstate-ui"` | Repository of the ui component Docker image. |
...
| stackstate.components.vmagent.image.repository | string | `"suse-observability/vmagent"` |  |
| stackstate.components.vmagent.image.tag | string | `"v1.109.0-ad5fe3d4"` |  |
...
| stackstate.components.wait.image.registry | string | `"registry.rancher.com"` | Base container image registry for wait containers. |
| stackstate.components.wait.image.repository | string | `"suse-observability/wait"` | Base container image repository for wait containers. |
...
| stackstate.stackpacks.image.registry | string | `"registry.rancher.com"` | `registry` used for the `stackpacks` Docker image; this will override `global.imageRegistry` on a per-service basis. |
| stackstate.stackpacks.image.repository | string | `"suse-observability/stackpacks"` | Repository of the `stackpacks` Docker image. |
| stackstate.stackpacks.image.version | string | `"20250422124003-master-a407dff"` | Version used for the `stackpacks` Docker image, the tag is build from the version and the stackstate edition + deployment mode |
...
| victoria-metrics-0.backup.setupCron.image.registry | string | `"registry.rancher.com"` |  |
| victoria-metrics-0.backup.setupCron.image.repository | string | `"suse-observability/container-tools"` |  |
| victoria-metrics-0.backup.vmbackup.image.registry | string | `"registry.rancher.com"` |  |
| victoria-metrics-0.backup.vmbackup.image.repository | string | `"suse-observability/vmbackup"` |  |
...
| victoria-metrics-0.server.image.registry | string | `"registry.rancher.com"` |  |
| victoria-metrics-0.server.image.repository | string | `"suse-observability/victoria-metrics"` |  |
...
| victoria-metrics-1.backup.setupCron.image.registry | string | `"registry.rancher.com"` |  |
| victoria-metrics-1.backup.setupCron.image.repository | string | `"suse-observability/container-tools"` |  |
| victoria-metrics-1.backup.vmbackup.image.registry | string | `"registry.rancher.com"` |  |
| victoria-metrics-1.backup.vmbackup.image.repository | string | `"suse-observability/vmbackup"` |  |
...
| victoria-metrics-1.server.image.registry | string | `"registry.rancher.com"` |  |
| victoria-metrics-1.server.image.repository | string | `"suse-observability/victoria-metrics"` |  |
...
| victoria-metrics.restore.image.registry | string | `"registry.rancher.com"` | Base container image registry for 'vmrestore' containers. |
| victoria-metrics.restore.image.repository | string | `"suse-observability/vmrestore"` | Base container image repository for 'vmrestore' containers. |
| victoria-metrics.restore.image.tag | string | `"v1.109.0-219ea492"` | Container image tag for 'vmrestore' containers. |
...
| victoriametrics-cluster.vminsert.image.registry | string | `"registry.rancher.com"` |  |
| victoriametrics-cluster.vminsert.image.repository | string | `"suse-observability/vminsert"` | Repository for vminsert |
...
| victoriametrics-cluster.vmselect.image.registry | string | `"registry.rancher.com"` |  |
| victoriametrics-cluster.vmselect.image.repository | string | `"suse-observability/vmselect"` | Repository for vmselect |
...
| victoriametrics-cluster.vmstorage.image.registry | string | `"registry.rancher.com"` |  |
| victoriametrics-cluster.vmstorage.image.repository | string | `"suse-observability/vmstorage"` | Repository for vmstorage |
...
| zookeeper.image.registry | string | `"registry.rancher.com"` | ZooKeeper image registry |
| zookeeper.image.repository | string | `"suse-observability/zookeeper"` | ZooKeeper image repository |
