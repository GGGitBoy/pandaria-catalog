...
![Version: 6.13.0](https://img.shields.io/badge/Version-6.13.0-informational?style=flat-square) ![AppVersion: 0.6.9](https://img.shields.io/badge/AppVersion-0.6.9-informational?style=flat-square)
...
|------------|------|---------|
| oci://dp.apps.rancher.io/charts | open-webui-pipelines | 0.5.0 |
| oci://dp.apps.rancher.io/charts | tika(apache-tika) | 3.0.0 |
| oci://dp.apps.rancher.io/charts | ollama | 1.11.0 |
| oci://dp.apps.rancher.io/charts | postgresql(postgresql) | 0.3.8 |
| oci://dp.apps.rancher.io/charts | redis-cluster(redis) | 1.0.3 |
...
| extraEnvVars | list | `[{"name":"OPENAI_API_KEY","value":"0p3n-w3bu!"},{"name":"WEBUI_NAME","value":"SUSE AI"}]` | Env vars added to the Open WebUI deployment. Most up-to-date environment variables can be found here: https://docs.openwebui.com/getting-started/env-configuration/ |
...
| image.tag | string | `"0.6.9"` | Image tag to use for the open-webui container |
...
| websocket.redis | object | `{"affinity":{},"annotations":{},"args":[],"command":[],"enabled":true,"image":{"pullPolicy":"IfNotPresent","registry":"dp.apps.rancher.io","repository":"containers/redis","tag":"7.4.2"},"labels":{},"name":"open-webui-redis","pods":{"annotations":{}},"resources":{},"securityContext":{},"service":{"annotations":{},"containerPort":6379,"labels":{},"nodePort":"","port":6379,"type":"ClusterIP"},"tolerations":[]}` | Deploys a redis |
...
| websocket.redis.image | object | `{"pullPolicy":"IfNotPresent","registry":"dp.apps.rancher.io","repository":"containers/redis","tag":"7.4.2"}` | Redis image |
| websocket.redis.image.pullPolicy | string | `"IfNotPresent"` | Image pull policy to use for the redis container |
| websocket.redis.image.registry | string | `"dp.apps.rancher.io"` | Image registry to use for the redis container |
| websocket.redis.image.repository | string | `"containers/redis"` | Image repository to use for the redis container |
| websocket.redis.image.tag | string | `"7.4.2"` | Image tag to use for the redis container |
